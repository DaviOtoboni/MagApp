      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 text-center">
            <div className="mx-auto w-20 h-20 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mb-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
              >
                Tentar outro email
              </button>
              ...
              <Link 
                href="/login"
                className="w-full flex justify-center py-4 border-2 border-gray-200 rounded-xl text-gray-700 font-medium hover:border-blue-300 hover:text-blue-600 transition-all duration-200 hover:shadow-md"
              >
                Voltar ao login
              </Link>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
          ...
          <Link 
            href="/login"
            className="w-full flex justify-center py-3 px-4 border-2 border-gray-200 rounded-xl text-gray-700 font-medium hover:border-blue-300 hover:text-blue-600 transition-all duration-200 hover:shadow-md"
          >
